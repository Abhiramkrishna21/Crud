import { Button, Checkbox, Dialog, DialogContent, DialogTitle, FormControlLabel, Paper, Radio, RadioGroup, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TextField } from '@mui/material'
                ...
                <DialogContent>
                    <form onSubmit={handlesubmit}>
                        <Stack spacing={2} margin={2}>
                            ...
                            <RadioGroup value={type} onChange={e => { typechange(e.target.value) }} variant='outlined' label="Type">
                                <row>
